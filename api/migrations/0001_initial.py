    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='api.document')),
        ...
        migrations.AddField(
            model_name='document',
            name='workflow',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.workflow'),
        ),
        migrations.CreateModel(
            name='WorkflowStep',
            fields=[
